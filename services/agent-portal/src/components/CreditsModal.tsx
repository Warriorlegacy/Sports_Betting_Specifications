...
export const CreditsModal: React.FC<CreditsModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-md animate-in fade-in duration-200 select-none">
      <div className="w-full max-w-2xl bg-slate-900 border border-slate-800 rounded-2xl p-5 sm:p-7 shadow-2xl relative z-10 text-white max-h-[90vh] flex flex-col overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between pb-4 border-b border-slate-800 shrink-0">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Architect, Lead Engineer & Founder</p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto space-y-5 pr-1 text-xs py-4">
          ...
          <div className="p-5 rounded-2xl bg-gradient-to-b from-slate-800 to-slate-950 border border-slate-700 relative overflow-hidden shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-[#f36c21] to-amber-400 p-0.5 shrink-0 shadow-lg">
                <div className="w-full h-full bg-slate-900 rounded-[14px] flex items-center justify-center font-black text-2xl text-transparent bg-clip-text bg-gradient-to-tr from-[#f36c21] to-amber-300 font-mono">
                  PR
                </div>
              </div>
            ...
            {/* Social Links */}
            <div className="mt-4 pt-4 border-t border-slate-700/60 grid grid-cols-2 sm:grid-cols-4 gap-2">
              <a
                href="https://www.instagram.com/piyushrajsingh.golu?igsh=eHFnNnhwZjJyYmo2&utm_source=qr"
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center space-x-1.5 p-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 text-pink-400 hover:text-pink-300 font-bold transition-all text-[11px]"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center space-x-1.5 p-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 text-blue-400 hover:text-blue-300 font-bold transition-all text-[11px]"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center space-x-1.5 p-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 text-amber-400 hover:text-amber-300 font-bold transition-all text-[11px]"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center space-x-1.5 p-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 text-white hover:text-slate-200 font-bold transition-all text-[11px]"
              >
          ...
          <div className="space-y-2">
            <span className="text-[11px] uppercase font-black tracking-wider text-slate-400 flex items-center gap-1.5">
        ...
        {/* Footer */}
        <div className="pt-3 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-2 text-[11px] text-slate-400 shrink-0 text-center sm:text-left">
          ...
          <span className="font-mono text-[10px] text-slate-500">"Type less. Signhify everything."</span>
        </div>
      </div>
    </div>
  );
